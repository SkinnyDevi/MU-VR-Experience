    ...
    public override void GrabBegin(OVRGrabber hand, Collider grabPoint)
    {
		...
		switch(SceneManager.GetActiveScene().name)
		{
			...
			case "TheatreCinema":
				...
				GameObject.Find("CustomHandRight").GetComponent<CustomHandGrabber>().ForceRelease(this);
				GameObject.Find("CustomHandLeft").GetComponent<CustomHandGrabber>().ForceRelease(this);	
